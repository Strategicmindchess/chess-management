...
export let POST = withLogging(async function(req: NextRequest, { params }: { params: Promise<{ coachId: string }> }) {
...
export let GET = withLogging(async function(req: NextRequest, { params }: { params: Promise<{ coachId: string }> }) {
    const { coachId } = await params;
    try {
