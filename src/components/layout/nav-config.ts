import { CalendarDays, LayoutDashboard, Users, IndianRupee, ClipboardCheck } from "lucide-react";
...
export const NAV_ITEMS: Record<Role, NavItem[]> = {
  ...
  [Role.STUDENT]: [
    ...
    { href: "/student/my-classes", label: "Today's Classes", icon: CalendarDays },
    { href: "/student/upcoming-classes", label: "Upcoming Classes", icon: CalendarDays },
