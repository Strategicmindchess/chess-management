import { CalendarDays, LayoutDashboard, Users, IndianRupee, ClipboardCheck, Trophy, Activity } from "lucide-react";
...
export const NAV_ITEMS: Record<Role, NavItem[]> = {
  [Role.ADMIN]: [
    ...
    { href: "/admin/data-sync", label: "Data Sync", icon: Activity },
