...
export function TabsList({
  ...
  return (
    <div
      className={cn(
        "inline-flex h-9 items-center justify-center rounded-lg bg-slate-100 p-1 text-slate-500 dark:bg-[#1a1f2e] dark:text-slate-400",
        className
      )}
    >
      {children}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive
          ? "bg-white text-slate-950 shadow dark:bg-[#242938] dark:text-white"
          : "hover:bg-slate-200 hover:text-slate-900 dark:hover:bg-[#242938] dark:hover:text-slate-200",
        className
      )}
    >
      {children}
